                    ...
                    builder: (context, snapshot) {
                      ...
                      if (_searchQuery.isNotEmpty) {
                        hotels = hotels.where((hotel) =>
                            ...
                            hotel.cityId.toLowerCase().contains(_searchQuery.toLowerCase())
                        ).toList();
                      }
                      if (hotels.isEmpty) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _searchQuery.isNotEmpty ? "No matching hotels" : "No Hotels Found",
              style: GoogleFonts.poppins(
                color: _AdminColors.dark,
                fontSize: 20,
                fontWeight: FontWeight.w700,
            ...
            Text(
              _searchQuery.isNotEmpty
                  ...
                  : "Tap the + button to add your first hotel",
              style: GoogleFonts.poppins(
